...
def pingsForLap(baseDateTime, pilotTimePerSector, pilotBeaconId, chrono0, chrono1, chrono2, chrono3):
  ...
  ping(baseDateTime + datetime.timedelta(milliseconds=pilotTimePerSector * 0), pilotBeaconId, -83, chrono0)
  ping(baseDateTime + datetime.timedelta(milliseconds=(pilotTimePerSector * 1)), pilotBeaconId, -83, chrono1)
  ping(baseDateTime + datetime.timedelta(milliseconds=(pilotTimePerSector * 2)), pilotBeaconId, -83, chrono2)
  ping(baseDateTime + datetime.timedelta(milliseconds=(pilotTimePerSector * 3)), pilotBeaconId, -83, chrono3)
