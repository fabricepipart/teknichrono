...
angular.module('frontend').controller('EditlLapTimeController', function ($scope, $routeParams, $location, flash, LapTimeResource, PilotResource, SessionResource, PingResource) {
    var self = this;
