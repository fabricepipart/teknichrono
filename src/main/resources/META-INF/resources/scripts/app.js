...
angular.module('frontend', ['ngRoute', 'ngResource'])
  .config(['$routeProvider', function ($routeProvider) {
    $routeProvider
      ...
      .when('/Chronometers/review/:ChronometerId', { templateUrl: 'views/Chronometer/review.html', controller: 'ReviewChronometerController' })
      .when('/Chronometers/logs/:ChronometerId', { templateUrl: 'views/Chronometer/logs.html', controller: 'LogsChronometerController' })
      ...
      .when('/ManageSessions', { templateUrl: 'views/Session/manage.html', controller: 'ManageSessionsController' })
