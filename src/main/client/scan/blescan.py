      ...
      if subevent == EVT_LE_CONN_COMPLETE:
        ...
        for i in range(0, num_reports):
          ...
          if (TRACE):
            ...
            printpacket(pkt[report_pkt_offset - 22:report_pkt_offset - 6])
            print()
            sys.stdout.write("\tMAJOR: ")
            printpacket(pkt[report_pkt_offset - 6:report_pkt_offset - 4])
            print()
            sys.stdout.write("\tMINOR: ")
            printpacket(pkt[report_pkt_offset - 4:report_pkt_offset - 2])
            print()
            sys.stdout.write("\tMAC address: " + packed_bdaddr_to_string(pkt[report_pkt_offset + 3:report_pkt_offset + 9]))

            print()
            # commented out - don't know what this byte is.  It's NOT TXPower
            sys.stdout.write("\t(Unknown): ")
            printpacket(pkt[report_pkt_offset - 2:report_pkt_offset - 1])
            print()
            sys.stdout.write("\tTX: ")
            printpacket(pkt[report_pkt_offset - 1:])
            print()
