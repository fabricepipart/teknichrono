...
public class EventEndpoint {
	...
	public Response findById(@PathParam("id") int id) {
		TypedQuery<Event> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT e FROM Event e LEFT JOIN FETCH e.chronopoints LEFT JOIN FETCH e.laptimes WHERE e.id = :entityId ORDER BY e.id",
						Event.class);
	...
	public List<Event> listAll(@QueryParam("start") Integer startPosition,
		...
		TypedQuery<Event> findAllQuery = em
				.createQuery(
						"SELECT DISTINCT e FROM Event e LEFT JOIN FETCH e.chronopoints LEFT JOIN FETCH e.laptimes ORDER BY e.id",
						Event.class);
