...
public class PiPilotsEndpoint {
	...
	public Response create(PiPilots entity) {
		...
		return Response.created(
				UriBuilder.fromResource(PiPilotsEndpoint.class)
	...
	public Response findById(@PathParam("id") int id) {
		TypedQuery<PiPilots> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT p FROM PiPilots p WHERE p.id = :entityId ORDER BY p.id",
						PiPilots.class);
	...
	@GET
	@Produces("application/json")
	public List<PiPilots> listAll(@QueryParam("start") Integer startPosition,
			@QueryParam("max") Integer maxResult) {
		TypedQuery<PiPilots> findAllQuery = em.createQuery(
				"SELECT DISTINCT p FROM PiPilots p ORDER BY p.id",
				PiPilots.class);
